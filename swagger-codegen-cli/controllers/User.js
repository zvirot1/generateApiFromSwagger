...
module.exports.createUser = function createUser (req, res, next, id, username, firstName, lastName, email, password, phone, userStatus) {
...
module.exports.updateUser = function updateUser (req, res, next, id, username, firstName, lastName, email, password, phone, userStatus, username) {
  User.updateUser(id, username, firstName, lastName, email, password, phone, userStatus, username)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
