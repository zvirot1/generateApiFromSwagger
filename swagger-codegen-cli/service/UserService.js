 ...
 * returns User
 **/
exports.createUser = function(id,username,firstName,lastName,email,password,phone,userStatus) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = {
  "firstName" : "John",
 ...
 * no response value expected for this operation
 **/
exports.updateUser = function(id,username,firstName,lastName,email,password,phone,userStatus,username) {
  return new Promise(function(resolve, reject) {
    resolve();
  });
}
